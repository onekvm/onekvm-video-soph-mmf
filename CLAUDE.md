...
- 没有 WebRTC 消费者时 Core `videoLoop` 停在 `waitForConsumer`，不会调 `maybe_rebuild`。HDMI 探测必须在 MMF source 自己的 watcher 里跑，不能指望拉流循环。r27 `b97e55d` 已上 137。切 1080 时 LT6911 会先报 `960x366`，要推断成 1920x1080。
