...
- 2560×1440@30：VI UYVY 有画面。VPSS **1:1** UYVY→NV21 写出全 0，WebRTC 是黑帧；同样输入缩到 1920×1080 则 NV21 有像素。2558 宽 crop 会 `vpss_handle_offline event timeout`。2K 编码还不能走 1:1 VPSS。详见仓库 `docs/2k-30.md`。ION **64 MiB @ 0x85000000**，公共 VB UYVY×3。`kMaxViReceiver` 仍是 1920×1080。活着的受支持模式不要探 LT6911 I2C。
